...
raw_dir <- here("ms", "lobbyists", "data", "raw")
# clients <- here(raw_dir,"")
...
ms_url_cl <- glue("https://sos.ms.gov/elec/Config/Mississippi/Elections/Handlers/ExportClientDirectoryToExcel.ashx?type=1&year={2009:2019}&lastName=&firstName=&clientName=, ")
...
ms_lobby_cl <- ms_cl_files %>% map(read_xls, skip = 10) %>% 
