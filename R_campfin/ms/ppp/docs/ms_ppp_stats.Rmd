...
are exactly the same and some are in fact from the same bank. A text file with
these repeated businesses has been created.
...
Pizza franchises, _three_ of which reportedly retained the _maximum_ 500 jobs
