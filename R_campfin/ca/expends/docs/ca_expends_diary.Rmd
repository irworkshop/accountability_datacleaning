...
expn_lines <- read_lines(expn_path)
good_lines <- str_count(x, "\t") == 52
sum(good_lines)
expn_tmp <- file_temp(ext = "tsv")
write_lines(expn_lines[good_lines], expn_tmp)
rm(expn_lines, good_lines); flush_memory()
```
