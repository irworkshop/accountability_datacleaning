...
Data is obtained from the North Carolina Secretary of State's office [Lobbying Download webpage][03]. From there, we
can download the database for all terms including resigned lobbyists in a a rich text file. We'll make a
`httr::GET()` request on the file to download write the text file to disk.
