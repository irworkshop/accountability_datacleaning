...
```
    ...
    #> Variables: 29
    #> $ org_id                   <chr> "2793", "5272", "8767", "652", "2081", "4500", "9089", "9307", …
    #> $ expenditure_amount       <dbl> 99.95, 146.95, 79.81, 23.95, 24.01, 303.98, 870.24, 6154.33, 25…
    #> $ expenditure_date         <date> 2018-11-20, 2013-08-02, 2016-04-30, 2016-01-31, 2019-06-23, 20…
    #> $ last_name                <chr> "AMAZON", "Jenney Station", "STAPLES", "PAYPAL", "Waldo County …
    #> $ first_name               <chr> NA, NA, NA, NA, NA, NA, NA, NA, "Henry", NA, NA, "ROBIN", NA, N…
    #> $ middle_name              <chr> NA, NA, NA, NA, NA, NA, NA, NA, "E", NA, NA, NA, NA, NA, NA, NA…
    #> $ suffix                   <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
    #> $ address1                 <chr> "PO BOX 81226", NA, "14 CROSSING WAY SUIRE 3", "POBOX 45950", "…
    #> $ address2                 <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
    #> $ city                     <chr> "SEATTLE", NA, "AUGUSTA", "OMAHA", "Lincolnville", NA, "CLEVELA…
    #> $ state                    <chr> "WA", "  ", "ME", "NE", "ME", NA, "OH", "OH", "  ", "GA", "ME",…
    #> $ zip                      <chr> "98108", NA, "04330", "68145-0950", "04849", NA, "44114", "4321…
    #> $ explanation              <chr> "FAX MACH", "travel", "1 COMPUTER INK\r\n2 REAMS OF COMPUTER PA…
    #> $ expenditure_id           <chr> "631644", "39373", "143139", "139574", "646112", "51287", "1483…
    #> $ filed_date               <date> 2018-12-18, 2013-11-15, 2016-06-01, 2016-04-08, 2019-07-02, 20…
    #> $ purpose                  <chr> "Equipment (office machines, furniture, cell phones, etc.)", "T…
    #> $ expenditure_type         <chr> "Monetary (Itemized)", "Monetary (Itemized)", "Monetary (Itemiz…
    #> $ committee_type           <chr> "Political Action Committee", "Political Action Committee", "Ca…
    #> $ committee_name           <chr> "STILL FED UP WITH TAXES", "Respect Maine", NA, "MAINE ASSOCIAT…
    #> $ candidate_name           <chr> NA, NA, "GAY M GRANT", NA, NA, "Ms. Rosa Walton Scarcelli", "ST…
    #> $ amended                  <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, …
    #> $ legacy_id                <chr> "4489", NA, NA, NA, "3152", NA, NA, NA, NA, NA, NA, NA, "10962"…
    ...
    #> $ office                   <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "SENATOR", NA, …
    #> $ district                 <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "35", NA, NA, N…
    #> $ report_name              <chr> "42-Day Post-General Report", NA, NA, NA, "July Quarterly Repor…
...
```
    ...
    #>    <chr>                        <chr>                        <chr>    <chr>                        
    #>  1 14 WINTHROP ST               14 WINTHROP ST               <NA>     14 WINTHROP STREET           
    #>  2 371-TARGET INDUSTRIAL CIRCLE 371-TARGET INDUSTRIAL CIRCLE <NA>     371 TARGET INDUSTRIAL CIRCLE 
    #>  3 ""                           <NA>                         <NA>     <NA>                         
    #>  4 565 CONGRESS ST, SUITE 200   565 CONGRESS ST, SUITE 200   <NA>     565 CONGRESS STREET SUITE 200
    #>  5 PO BOX 888016                PO BOX 888016                <NA>     PO BOX 888016                
    #>  6 126 SEWALL STREET            126 SEWALL STREET            <NA>     126 SEWALL STREET            
    #>  7 1 Post Office Sq.            1 Post Office Sq.            <NA>     1 POST OFFICE SQUARE         
    #>  8 ""                           <NA>                         <NA>     <NA>                         
    #>  9 20 COOMBS RD                 20 COOMBS RD                 <NA>     20 COOMBS ROAD               
    #> 10 ON-LINE                      ON-LINE                      <NA>     ON LINE
...
#>  [1] "04814"   "04194"   "03186"   "05938"   "04277"   "M5J 2R8" "04200"   "37021"   "05005"  
#> [10] "94068"   "4695"    "V6E 4A2" "N4K 3R9" "04502"   "04322"   "04248"   "04025"   "54264"  
#> [19] "04440"   "97100"
```
