...
tibble(
  ...
  prop_in = c(
    prop_in(me$city_raw, valid_city, na.rm = TRUE),
    prop_in(me$city_norm, valid_city, na.rm = TRUE),
    prop_in(me$city_swap, valid_city, na.rm = TRUE)
  ),
  unique_bad = c(
    length(setdiff(me$city_raw, valid_city)),
    length(setdiff(me$city_norm, valid_city)),
    length(setdiff(me$city_swap, valid_city))
  )
)
```
