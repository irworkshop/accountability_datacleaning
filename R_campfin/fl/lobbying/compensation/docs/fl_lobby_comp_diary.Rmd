...
fs::dir_create(here::here("fl", "lobbying", "compensation", "docs"))
```
...
```{r create_raw_dir}
raw_dir <- here("fl", "lobbying", "compensation", "data", "raw")
dir_create(raw_dir)
```
...
fllc %>% 
  count(report_year, report_quarter) %>% 
  ggplot(aes(x = report_year, y = n)) +
  geom_col(aes(fill = report_quarter)) +
  scale_fill_brewer(palette = "Dark2") +
  scale_y_continuous(labels = comma) +
  scale_x_continuous(labels = 2008:2019, breaks = 2008:2019) +
  labs(
    title = "Flordina Lobbyist Compensation Reports",
    x = "Report Year",
    y = "Filed Reports",
    fill = "Report Quarter"
  )
