...
dir_create(reg_dir)
```
The [Louisiana Board of Ethics] [03] makes available a listing of all current lobbyists (2019). The Accountability Project obtained records of previous years through a public record request.
