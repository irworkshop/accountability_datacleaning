...
`r percent(prop_in(co$state, geo$state, na.rm = TRUE))` of `state` values are already valid.
...
`r percent(prop_in(co$city_clean,geo$city,na.rm = TRUE)-prop_in(co$city,geo$city,na.rm = TRUE))`,
from `r percent(prop_in(co$city,geo$city,na.rm = TRUE))` to 
`r percent(prop_in(co$city_clean,geo$city,na.rm = TRUE))`
