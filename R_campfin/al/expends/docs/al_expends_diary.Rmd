...
For the continous variables, we can explore the distrobution of values with 
...
The range of `expenditure_date` is entirely reasonablem, as is `filed_date`. There are
