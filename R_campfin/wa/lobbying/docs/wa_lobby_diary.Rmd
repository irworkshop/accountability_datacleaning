...
Then, for each row, we attempt to extract every city name for that row's state from the end of the
string.
...
The `state_sep` variable is `r percent(prop_in(wa$state_sep, valid_state))` valid.
