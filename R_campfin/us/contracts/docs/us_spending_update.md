...
con_files <- glue("FY{year(today())}_All_Contracts_Full_20200513.zip")
con_urls <- str_c(base_url, con_files)
con_zips <- path(zip_dir, con_files)
```

    #> [1] "https://files.usaspending.gov/award_data_archive/FY2020_All_Contracts_Full_20200513.zip"
    #> [1] "~/us/contracts/data/zip/FY2020_All_Contracts_Full_20200513.zip"
...
``` r
delta_file <- "FY(All)_All_Contracts_Delta_20200513.zip"
...
#> 1 58566792  41.6  4.97 7.15e+12 2000-10-01 2020-05-11 0.0000000683 0.172 0.966  1.00 0.982
```
...
| `FY2020_1.csv`  | 1000000 | 2020-01-22 | 2020-05-11 |       0 | 160161 | 98.8% | 100.0% | 99.1% |
| `FY2020_2.csv`  | 1000000 | 2019-11-14 | 2020-01-22 |       1 | 125641 | 97.8% | 100.0% | 98.6% |
| `FY2020_3.csv`  |  661427 | 2019-10-01 | 2019-11-14 |       0 |  90450 | 97.8% | 100.0% | 98.7% |
| `FY(All)_1.csv` | 1000000 | 2000-10-01 | 2020-05-11 |       0 |  91011 | 98.7% | 100.0% | 99.2% |
| `FY(All)_2.csv` |  495620 | 2000-10-01 | 2020-04-28 |       3 |  27299 | 96.2% | 100.0% | 98.5% |
