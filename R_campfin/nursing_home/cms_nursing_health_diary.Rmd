---
title: "Nursing Home Compare Data Diary -- infectionship"
author: "Yanqi Xu"
date: "`r Sys.time()`"
output:
  github_document: 
...
[03]: https://data.medicare.gov/Nursing-Home-Compare/Emergency-Preparedness-Deficiencies/9ezk-fzua

## Data

The Emergency Preparedness file is obtained from the [Medicare.gov][03]. The data is as current as March 16, 2020. 
First, we will read the infectionship data. We can also view the record layout from the `infectionship` sheet `DataMedicareGov_MetadataAllTabs_v23.xlsx`.
