---
title: "Virginia Lobbying Expenditure Diary"
author: "Yanqi Xu"
date: "`r Sys.time()`"
output:
  github_document: 
...
## Data
Lobbyist data is obtained via a public record request from the [Virginia State Ethics Commission][03].
...
vale%>% 
  ...
  labs(
    ...
    caption = "Source: Virginia State Ethics Commission",
    x = "median expenses",
    y = 'dollar'
  )
...
prop_in(valr$employer_city, valid_city, na.rm = T)
...
prop_in(valr$employer_city_norm, valid_city, na.rm = T)
```
...
progress <- progress_table(
  ...
  valr$employer_city_norm,
  valr$lobbyist_address_city_swap,
valr$employer_city_swap,
  compare = many_city
