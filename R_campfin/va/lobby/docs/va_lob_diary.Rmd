...
## Data
Lobbyist data is obtained via a public record request from the [Virginia State Ethics Commission][03] in April of 2020.
...
prop_in(valr$principal_authorizing_officer_address_city_norm, valid_city, na.rm = T)
```
