...
We know the file was properly read as the number of rows is equal to the number of distinct
...
dozen parsing problems. These typically stem from an incorrect number of delimeter or escape
characters.
...
We can repair the data frame using the `janitor` package and by filtering out those few
