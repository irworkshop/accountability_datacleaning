...
There are `r nrow(df)` records of `r length(df)` variables in the full database.
...
We need to extract the ZIP code and state abbreviation from the `payee_address` string.
