...
[03]: https://www.dos.pa.gov/VotingElections/CandidatesCommittees/CampaignFinance/Resources/Documents/readme.txt. "here" 
[04]: https://www.dos.pa.gov/VotingElections/CandidatesCommittees/CampaignFinance/Documents/FAQ/CampaignFinanceFAQ.pdf "FAQs"
[05]: https://www.dos.pa.gov/VotingElections/CandidatesCommittees/CampaignFinance/Resources/Pages/FullCampaignFinanceExport.aspx "website"



## Data

The Pennsylvania campaign expenditure data is made available by the [Pennsylvania Department of State's website][05].


### About


[FAQs][04] about Pennsylvania Campaign Finance regulations:


### Variables
More information about the record layout can be found [here][03].

## Import

### Download

Download raw, **immutable** data file. Go to [Pennsylvania Department of State's website][05].
We'll download the files from 2015 to 2019 (file format: zip file) with the following code.
...
```{r write_filer clean, echo = FALSE, execute = FALSE}
...
pa_filer %>% 
  select(
   ...
   rename(filer_address_clean = address_clean,
         ...
         filer_state = STATE) %>% 
  write_csv(
    path = glue("{clean_dir}/pa_filer_clean.csv"),
    na = ""
  )
```
