...
To generate a master dataset, we will need to download relationship data from [Utah Lieutenant Governor's Office](https://lobbyist.utah.gov/Search/LobbyistByPrincipal). By setting the filters to "ALL", we can get the information from earch year.
