South Dakota Lobbying Registration Data Diary
================
Yanqi Xu
2020-02-26 16:13:11
...
head(sd_reg)
#> # A tibble: 6 x 16
#>   year  registration_nu… registration_st… lobbyist lobbyist_city_s… lobbyist_phone_… employer
#>   <chr> <chr>            <chr>            <chr>    <chr>            <chr>            <chr>   
#> 1 2016  60707            Active           MARCHAN… CAMBRIDGE , WI … (202) 309-1421   BRISTOL…
#> 2 2016  60768            Active           HOOD, J… SPEARFISH, SD 5… <NA>             SOUTH D…
#> 3 2016  60769            Active           HOOD, J… SPEARFISH, SD 5… <NA>             SOUTH D…
#> 4 2016  61690            Active           HOOD, J… SPEARFISH, SD 5… <NA>             AMERICA…
#> 5 2016  60840            Active           HOOD, J… SPEARFISH, SD 5… <NA>             MISSOUR…
#> 6 2016  60841            Active           HOOD, J… SPEARFISH, SD 5… <NA>             SOUTH D…
#> # … with 9 more variables: employer_address <chr>, employer_city_state_zip <chr>, ext_url <chr>,
#> #   employment_date <chr>, occupation <chr>, status <chr>, employer_registration_date <chr>,
#> #   authorization_date <chr>, legislation_subject <chr>
tail(sd_reg)
#> # A tibble: 6 x 16
#>   year  registration_nu… registration_st… lobbyist lobbyist_city_s… lobbyist_phone_… employer
#>   <chr> <chr>            <chr>            <chr>    <chr>            <chr>            <chr>   
#> 1 2020  103274           Pending Authori… McMahon… Arlington, VA 2… bseitelman@mult… Associa…
#> 2 2020  103276           Active           Cauwels… Sioux Falls, SD… Jeremy.Cauwels@… Sanford…
#> 3 2020  103277           Active           Hoover,… Sioux Falls, SD… Susan.Hoover@Sa… Sanford…
#> 4 2020  103278           Pending Authori… Hsu, Be… Sioux Falls, SD… bshhsu@gmail.com South D…
#> 5 2020  103280           Active           Satter,… SIOUX FALLS, SD… Molly.Satter@k1… Sioux F…
#> 6 2020  103281           Pending Authori… Morlock… BROOKINGS, SD 5… mmorlock@pheasa… Pheasan…
#> # … with 9 more variables: employer_address <chr>, employer_city_state_zip <chr>, ext_url <chr>,
#> #   employment_date <chr>, occupation <chr>, status <chr>, employer_registration_date <chr>,
#> #   authorization_date <chr>, legislation_subject <chr>
...
#> $ registration_number        <chr> "62092", "102720", "100930", "102827", "62221", "101003", "10…
#> $ registration_status        <chr> "Active", "Active", "Active", "Active", "Active", "Active", "…
#> $ lobbyist                   <chr> "DIEGEL, JASPER", "Bachand, Paul E", "Hatting, Tammy", "Mille…
#> $ lobbyist_city_state_zip    <chr> "PIERRE, SD 57501", "Pierre, SD 57501", "Sioux Falls, SD 5710…
#> $ lobbyist_phone_email       <chr> "(605) 929-8869carrelv@sdchamber.biz", "(605) 222-4234pbachan…
#> $ employer                   <chr> "SD CHAMBER OF COMMERCE & INDUSTRY", "South Dakota Academy of…
#> $ employer_address           <chr> "PO  BOX 190", "120 S Madison Avenue", "3708 W. Brooks Place"…
#> $ employer_city_state_zip    <chr> "PIERRE, SD 57501", "Pierre, SD 57501", "Sioux Falls,, SD 571…
#> $ ext_url                    <chr> "https://sosenterprise.sd.gov/BusinessServices/Lobbyist/Lobby…
#> $ employment_date            <chr> "12/15/2016", "12/18/2019", "4/6/2018", "1/5/2020", "12/21/20…
#> $ occupation                 <chr> "YBA EXECUTIVE DIRECTOR", "Attorney", "Vice President, Post-A…
#> $ status                     <chr> "Active", "Active", "Active", "Active", "Active", "Active", "…
#> $ employer_registration_date <chr> "12/15/2016", "12/18/2019", "11/27/2018", "1/6/2020", "12/21/…
#> $ authorization_date         <chr> "12/14/2016", "12/18/2019", "11/27/2018", "1/14/2020", "12/21…
#> $ legislation_subject        <chr> NA, "all health related matters or of interest to physician a…
```
...
#>  3 registration_status        <chr>     0 0      
#>  4 lobbyist                   <chr>     0 0      
#>  5 lobbyist_city_state_zip    <chr>     0 0      
#>  6 lobbyist_phone_email       <chr>   245 0.0798 
#>  7 employer                   <chr>     0 0      
#>  8 employer_address           <chr>     0 0      
#>  9 employer_city_state_zip    <chr>     0 0      
#> 10 ext_url                    <chr>     0 0      
#> 11 employment_date            <chr>     0 0      
#> 12 occupation                 <chr>     6 0.00196
#> 13 status                     <chr>     0 0      
#> 14 employer_registration_date <chr>     0 0      
#> 15 authorization_date         <chr>    47 0.0153 
#> 16 legislation_subject        <chr>  1229 0.400
```
...
#>    col                        class     n        p
#>    <chr>                      <chr> <int>    <dbl>
#>  1 year                       <chr>     5 0.00163 
#>  2 registration_number        <chr>  3069 1       
#>  3 registration_status        <chr>     3 0.000978
#>  4 lobbyist                   <chr>  1065 0.347   
#>  5 lobbyist_city_state_zip    <chr>   431 0.140   
#>  6 lobbyist_phone_email       <chr>  1009 0.329   
#>  7 employer                   <chr>   989 0.322   
#>  8 employer_address           <chr>  1028 0.335   
#>  9 employer_city_state_zip    <chr>   399 0.130   
#> 10 ext_url                    <chr>  3069 1       
#> 11 employment_date            <chr>   519 0.169   
#> 12 occupation                 <chr>   683 0.223   
#> 13 status                     <chr>     2 0.000652
#> 14 employer_registration_date <chr>   397 0.129   
#> 15 authorization_date         <chr>   428 0.139   
#> 16 legislation_subject        <chr>  1121 0.365
```
...
|:---------------------|----------:|------------:|---------:|-------:|--------:|
| lobbyist\_city       |  0.9543825|          251|         0|     140|       37|
| lobbyist\_city\_norm |  0.9837080|          236|         0|      50|       18|
| lobbyist\_city\_swap |  0.9941349|          222|         0|      18|        4|
| employer\_city\_swap |  0.9996742|          171|         0|       1|        1|
| employer\_city       |  0.9511241|          200|         0|     150|       33|
| employer\_city\_norm |  0.9876181|          179|         0|      38|       10|
| employer\_city\_swap |  0.9996742|          171|         0|       1|        1|
