...
njl <- select(njl, -firm_address, -phone_number2)
njl <- rename(njl, firm_phone = phone_number)
```
...
Next, we'll want to read the file containing additional information regarding
the lobbying agents.
...
To prepare to join the files together, we need to adjust some variable names.
...
dict_raw <- tibble(
  ...
  def = c(
    ...
    "Firm business city",
    "Firm business state",
    "Firm business ZIP code",
    "Agent date terminated",
    "Agent termination effective",
