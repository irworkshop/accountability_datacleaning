---
title: "Data Diary"
subtitle: "Oklahoma Contributions"
...
```{r count_clean_states, collapse=TRUE}
n_distinct(ok$cont_state_clean)
setdiff(ok$cont_state_clean, valid_abb)
```

```{r count_bad_states_rec, collapse=TRUE}
...
ok %>% 
  ...
  write_csv(
    path = here("ok_contribs", "data", "ok_contribs_clean.csv"),
    na = ""
  )
```
