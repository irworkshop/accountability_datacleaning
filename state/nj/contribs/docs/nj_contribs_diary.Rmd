...
qd <- "https://www.elec.state.nj.us/publicinformation/contrib_quickdownload.htm"
read_html(qd) %>% 
  html_nodes("h5") %>% 
  html_text() %>% 
...
[elec]: https://www.elec.state.nj.us/ELECReport/
[quick]: https://www.elec.state.nj.us/publicinformation/quickdownload.htm
...
njc %>% 
  count(cont_year) %>%
  filter(between(cont_year, 1978, 2015)) %>% 
