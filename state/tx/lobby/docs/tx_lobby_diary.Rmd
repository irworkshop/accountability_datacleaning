...
The data can be obtained from the [Texas Ethics Commission][tec]. The download page lists data files from 2001 and on. Since the older files are in a format relatively hard to wrangle. We here include only lobbying records from 2016 on. The 2023 file was updated on 2023-07-09.
