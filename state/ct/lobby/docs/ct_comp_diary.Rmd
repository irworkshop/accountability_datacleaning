...
ct_dedupe[[i]]$early_more_info <- NA
  # early_more_info suggests whether the first entry has more information
  ct_dedupe[[i]]$row_sum[1] < ct_dedupe[[i]]$row_sum[2]
...
1. There are `r nrow(ctlc)` records in the database.
1. There are `r sum(ctlc$dupe_flag)` duplicate records in the database.
