...
While [Vermont Campaign Finance System][cfs] indicates that information surrounding contributions can be traced back to 1975, the earliest date in the system where public information is available is 2014. We will save this exported text file locally.
...
```
```{r}
raw_csv <- read_csv("ViewContributionsList.csv")
```
