...
doc_dir <- fs::dir_create(here::here("la", "expends", "docs"))
```
...
limited to the top 100,000 of 1,285,753 records that match your search criteria
and sorting selection.

To circumvent this cap, we perform multiple searches between the start and end
of the years between 2000 and 2020. The [cURL] commands to download these chunks
