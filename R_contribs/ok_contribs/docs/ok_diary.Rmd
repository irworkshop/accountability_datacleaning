...
will be made "clean" using `janitor::clean_names()`.
...
The relational databases will be combined into a single data frame using the respective `*_id`
variables.

There are four types of contributors, each identified with different `cont_*name` variable:
