...
## Weekly average
Since the hours reported during the week and weekend are usually different, we sum up the weekly total and get a weekly average. 
```{r}
...
It looks like that staffing decreased in April and ticked up again in May.
```{r}
